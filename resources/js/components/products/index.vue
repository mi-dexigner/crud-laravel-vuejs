...
<div class="products__list table  my-3">
        ...
        <div class="table--items products__list__item" v-for="item in products" :key="item.id" v-if="products.length > 0">
            <div class="products__list__item--imgWrapper">
                <img class="products__list__item--img" :src="ourImage(item.photo)" v-if="item.photo"  style="height: 40px;">
            </div>
        ...
        <div  class="table--items products__list__item" v-else><p>Products Not Found</p></div>
