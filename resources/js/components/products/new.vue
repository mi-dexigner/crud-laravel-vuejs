...
const getPhoto = ()=>{
let photo = "/uploads/image.png";
if(form.value.photo){
if(form.value.photo.indexOf('base64') != -1){
photo = form.value.photo;
}else{
photo = '/uploads/'+ form.value.photo;
}
}
return photo;
}
...
const saveProduct = ()=>{
    ...
    axios.post("/api/add_product",formData).then((response)=>{
    form.value.name='';
...
<div class="products__create ">
                            ...
                            <ul class="products__create__main--media--images--list list-unstyled">
                                <li class="products__create__main--media--images--item">
                                    <div class="products__create__main--media--images--item--imgWrapper">
                                        <img class="products__create__main--media--images--item--img" :src="getPhoto()" v-if="form.photo" alt="" />  
                                    </div>
                                </li>
                                <!-- upload image small -->
                                <li class="products__create__main--media--images--item">
             ...
             <div class="dflex justify-content-between align-items-center my-3">
                 <p><button @click="backToHome()" class="btn btn-secondary">back</button></p>
